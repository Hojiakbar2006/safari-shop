...
export function Address() {
  ...
  const send = (e) => {
    ...
    openModal();
    user.id === ""? toast.info("Add Your Address") : toast.info("Edit Your Address")
  ...
  useEffect(() => {
    window.addEventListener("click", (e) => {
      if (e.target.className === "modal activClas") {
        setModal(false);
      }
    });
  });
  ...
  return (
    <div id="address">
      ...
      <div className={modal ? "modal activClas" : "modal"}>
        <div className="modal_body">
          ...
          <div className="close btn" onClick={openModal} style={{ cursor: "pointer" }}>
            X
          </div>
        </div>
      </div>
