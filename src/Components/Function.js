...
export function Category({
  ...
  const [disableCls, setDisableCls] = useState("all");
  const [disableClsSize, setDisableClsSize] = useState("all");
  return (
    <>
      <div id="Category">
          ...
          <div id="choose_size_card">
            {sizeData.map((item, index) => {
              return (
                <label
                  id="choose_size"
                  className={disableClsSize===item && "activ-size-btn"}
                  key={index}
                  onClick={() => {
                    CategorySize(item);
                    setDisableClsSize(item);
                  }}
                >
                  <p id="size">{item}</p>
                </label>
          ...
          {sizeData.map((item, index) => {
            return (
              <label
                ...
                key={index}
                onClick={() => {
                  CategorySize(item);setDisableClsSize(item);
...
return (
  <footer id="footer">
    ...
    <div id="footer_form_card">
      <p>Subscribe toour newsletter</p>
        <form>
